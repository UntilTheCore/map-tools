...
function getCenterBetweenRightPointIntersection(coordinates) {
    ...
    if (eastCoord) {
        ...
        var polygonCenterPointCoord1 = [
            polygonCenterPointCoord[0] + 0.5,
            polygonCenterPointCoord[1],
        ];
        var polygonCenterPointCoord2 = [
            polygonCenterPointCoord[0] - 0.5,
            polygonCenterPointCoord[1],
        ];
        var line1 = lineString([eastCoord, eastCoord1, eastCoord2], {
            name: "line 1",
        });
...
function checkCoordinate(coordinate) {
    var messageShouldArray = "坐标应该为一个只有两个元素的数组";
    var messageValueIsNotNumber = "坐标值应是 number";
...
})(exports.FeatureTypeEnum || (exports.FeatureTypeEnum = {}));
...
function setViewPort(map, overlays, option) {
    ...
    var pointList = getFeatureTypeList(overlays, exports.FeatureTypeEnum.Point);
    var lineStringList = getFeatureTypeList(overlays, exports.FeatureTypeEnum.LineString);
    var multiLineStringList = getFeatureTypeList(overlays, exports.FeatureTypeEnum.MultiLineString);
    var polygonList = getFeatureTypeList(overlays, exports.FeatureTypeEnum.Polygon);
    var multipolygonList = getFeatureTypeList(overlays, exports.FeatureTypeEnum.MultiPolygon);
...
function setPbfLayerViewport(data) {
    data = data || {};
    var map = data.map, layerId = data.layerId, sourceId = data.sourceId, _a = data.limit, limit = _a === void 0 ? 30 : _a, _b = data.autoZoom, autoZoom = _b === void 0 ? true : _b, _c = data.zoom, zoom = _c === void 0 ? 10 : _c, zoomFn = data.zoomFn;
    ...
    checkSourceLoaded({
        ...
        if (status) {
            var _feature = getPbfFeatureListSync(map, layerId);
 ...
 * @returns
 */
function checkSourceLoaded(data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        var map, sourceId, _a, limit, timer, counter;
        return __generator(this, function (_b) {
            data = data || {};
            map = data.map, sourceId = data.sourceId, _a = data.limit, limit = _a === void 0 ? 30 : _a;
            counter = 0;
            return [2 /*return*/, new Promise(function (resolve) {
                    if (!map || !sourceId) {
                        ...
                        timer = setInterval(function () {
                            var isLoaded = map.isSourceLoaded(sourceId);
                            if (isLoaded) {
                                _clearInterval();
                                counter = 0;
                                resolve(true);
 ...
 */
function getPbfFeatureListSync(map, pbfLayerId) {
    var features = map.queryRenderedFeatures({ layers: [pbfLayerId] });
    if (features && features.length > 0) {
        return features.map(function (item) { return feature(item.geometry, item.properties); });
    }
    return [];
}
/**
 ...
 */
function getPbfFeatureListAsync(map, layerId, sourceId, option) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, checkSourceLoaded({
                    map: map,
                    sourceId: sourceId,
                    ...
                    if (features && features.length > 0) {
                        return features.map(function (item) {
                            return feature(item.geometry, item.properties);
                        });
                    }
                    return [];
                })];
...
function getPopupDom(component, props) {
    ...
    var _component = vue.createApp(component, props);
    // 创建一个div元素作为组件的挂载目标。
...
function getLineStringEndpoint(lineFeatureCollection) {
    ...
    geomEach$1(lineFeatureCollection, function (currentGeometry) {
        ...
        if (type === exports.FeatureTypeEnum.LineString) {
            endPoints.push(coords[0]);
            endPoints.push(coords[coords.length - 1]);
        }
        else if (type === exports.FeatureTypeEnum.MultiLineString) {
...
function useMap(option) {
    ...
    var mapInstance = vue.ref(map);
    var mouseInfo = vue.reactive({
        lng: 0,
        lat: 0,
        x: 0,
        y: 0,
...
exports.checkSourceLoaded = checkSourceLoaded;
exports.clearAllSourceAndLayer = clearAllSourceAndLayer;
exports.destroyMap = destroyMap;
exports.getBearing = getBearing;
exports.getCenterBetweenRightPointIntersection = getCenterBetweenRightPointIntersection;
exports.getFeatureTypeList = getFeatureTypeList;
exports.getLineEndpoint = getLineEndpoint;
exports.getLineStringEndpoint = getLineStringEndpoint;
exports.getPbfFeatureListAsync = getPbfFeatureListAsync;
exports.getPbfFeatureListSync = getPbfFeatureListSync;
exports.getPolygonVertex = getPolygonVertex;
exports.getPopupDom = getPopupDom;
exports.getRotation = getRotation;
exports.getRotationByCoordinate = getRotationByCoordinate;
exports.hiddenLayer = hiddenLayer;
exports.hiddenLayers = hiddenLayers;
exports.hideLayer = hideLayer;
exports.hideLayers = hideLayers;
exports.moveAndZoom = moveAndZoom;
exports.moveMap = moveMap;
exports.pointListToCoordList = pointListToCoordList;
exports.removeMarkers = removeMarkers;
exports.removeMarkersOrPopups = removeMarkersOrPopups;
exports.setLayerIdName = setLayerIdName;
exports.setMultipleLayerSourceData = setMultipleLayerSourceData;
exports.setPbfLayerViewport = setPbfLayerViewport;
exports.setPbfSourceData = setPbfSourceData;
exports.setSourceData = setSourceData;
exports.setSourceIdName = setSourceIdName;
exports.setViewPort = setViewPort;
exports.setViewPortByPolygon = setViewPortByPolygon;
