 ...
 * 设置pbf图层视图
 */
function setPbfLayerViewport(map, pbfLayerId) {
    var _feature = getPbfGeometry(map, pbfLayerId);
 ...
 * 获取pbf图层的geometry数据
 */
function getPbfGeometry(map, pbfLayerId) {
...
exports.getPbfGeometry = getPbfGeometry;
