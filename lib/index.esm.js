...
export { FeatureTypeEnum, checkCoordinate, checkSourceLoaded, clearAllSourceAndLayer, destroyMap, getBearing, getCenterBetweenRightPointIntersection, getFeatureTypeList, getLineEndpoint, getLineStringEndpoint, getPbfFeatureListAsync, getPbfFeatureListSync, getPolygonVertex, getPopupDom, getRotation, getRotationByCoordinate, hiddenLayer, hiddenLayers, hideLayer, hideLayers, moveAndZoom, moveMap, pointListToCoordList, removeMarkers, removeMarkersOrPopups, setLayerIdName, setMultipleLayerSourceData, setPbfLayerViewport, setPbfSourceData, setSourceData, setSourceIdName, setViewPort, setViewPortByPolygon, setZoom, showLayer, showLayers, toggleLayer, useMap };
