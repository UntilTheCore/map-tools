...
export { checkCoordinate, clearAllSourceAndLayer, destroyMap, getBearing, getCenterBetweenRightPointIntersection, getFeatureTypeList, getLineEndpoint, getLineStringEndpoint, getPolygonVertex, getPopupDom, getRotation, getRotationByCoordinate, hiddenLayer, hiddenLayers, moveAndZoom, moveMap, pointListToCoordList, removeMarkers, removeMarkersOrPopups, setLayerIdName, setMultipleLayerSourceData, setPbfSourceData, setSourceData, setSourceIdName, setViewPort, setViewPortByPolygon, setZoom, showLayer, showLayers, useMap };
